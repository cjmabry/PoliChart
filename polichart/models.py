...
class State(db.Model):
    ...
    clinton_pledged_delegates_results = Column(db.Float())
    sanders_pledged_delegates_results = Column(db.Float())
    clinton_unpledged_delegates_results = Column(db.Float())
    sanders_unpledged_delegates_results = Column(db.Float())
